        ...
        <div className="mb-4">
          <div className="transition-colors duration-100 bg-primary dark:bg-primary-dark">
            <a target="_blank" href="https://github.com/kms1601">
              <Github width={32} height={32} className="hover:fill-description dark:fill-secondary dark:hover:fill-description"></Github>
            </a>
          </div>
        </div>
        <div className="flex items-center">
          <p className="flex text-sm">&copy; 2024 kms1601. All rights reserved.</p>
        </div>
      </footer>
    </>
  );
