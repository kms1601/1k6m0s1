...
## 오늘의 문제 - 프로그래머스 Lv.2 [<a href="https://school.programmers.co.kr/learn/courses/30/lessons/147354" target="_blank" className="a-mdx">테이블 해시 함수</a>]
...
4. 테이블의 데이터 data와 해시 함수에 대한 입력 **col**, **row_begin**, **row_end**이 주어졌을 때 테이블의 해시 값을 return 하도록 solution 함수를 완성해주세요.
...
문제의 요구사항대로 데이터를 정렬해준 뒤, 해당 데이터들에 대해 나머지 연산을 하고 Bitwise XOR연산을 해주면 된다. 또한, 문제에서 주어지는 인덱스가 0이 아닌 1부터 시작한다는 것을 주의해야 한다.
